<script>
    ...
    let steps = [
        {
            ...
            description:
                "PostCard is a clone of Threads. Users have the ability to post cards, which are essentially brief written messages they wish to share with the entire PostCard community. It brings additional advantages to communities with cards specific to their own community.",
        },
        {
            name: "SareMe",
    ...
    let benefits = [
        ...
        {
            name: "a competitive programmer",
            description:
                "As a passionate competitive programmer, I thrive in the world of algorithmic challenges and coding competitions. With a strong foundation in data structures and algorithms, I tackle complex problems with precision and creativity, consistently ranking among the top performers in various online coding contests.",
        },
        {
            name: "an excellent communicator",
            description:
                "As a content writer and communicator, I create compelling content that connects. My portfolio spans diverse written works, demonstrating my adaptability across industries and writing styles. I'm dedicated to crafting engaging and impactful narratives that resonate with audiences.",
        },
    ];
</script>
...
<main class="flex flex-col flex-1 p-4">
    ...
    >
        ...
        >
            <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hi! I'm <span class="poppins text-violet-400">Sudhanshu</span> Shekhar
                <br />Full Stack
                <span class="poppins text-violet-400">Developer</span>
            </h2>
            <p class="text-base sm:text-lg md:text-xl">
                My <span class="text-violet-400"> favorite tech</span> includes JavaScript
                (NEXT.JS or ReactJS), TailwindCSS, Node.js + Express.js & MongoDB
                or Sanity.io!
            </p>
            <button
    ...
    <section class="py-20 lg:py-32 flex flex-col gap-24" id="projects">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-10">
            <Step step={steps[0]}>
                <p>
                    PostCard is a thought sharing social media platform created with <strong
                        class="text-violet-400"
                        >TypeScript, Next.js, MongoDB, clerk, Tailwind CSS!</strong
                    > Clerk is used for authentication and ChadCN is used for various UI's such as forms etc.
                </p>
            </Step>
            <Step step={steps[1]}>
                <p>
                    ShareMe is a Full Stack <strong
                        class="text-violet-400">ReactJS</strong
                    >,
                    <strong class="text-violet-400">Sanity.io and Google auth</strong
                    >
                    & <strong class="text-violet-400">tailwind CSS</strong> social media web app on which users can share their best images, wallpapers etc!.
                </p>
            </Step>
            <Step step={steps[2]}>
                <p>
                    Movie-Carusel is a <strong class="text-violet-400"
                        >ReactJS and Bootstrap</strong
                    >
                    web application, uses
                    <strong class="text-violet-400">trending movies API</strong>
                    to display all all the trending movies and web series !
                </p>
            </Step>
        </div>
    </section>
